...
<div class="row glossary-box glossary-box--home no-border<?php if( is_single() ) : echo ' box box-highlight'; endif; ?>">
  <div class="inner-wrapper">
    <div class="six-col">
      ...
      <p class="intro">Your source for Ubuntu news, articles, tutorials, e-books and everything else in-between.</p>
    </div>
...
<section class="box eight-col">
	<h2 class="section-title"><a href="/group/cloud-and-server/">Cloud and Server</a></h2>
    <?php
...
?><?php if (have_posts()) : ?>
<section class="box eight-col">
  <h2 class="section-title"><a href="/group/<?php echo $section; ?>">Internet of Things</a></h2>
...
?><?php if (have_posts()) : ?>
<section class="box eight-col">
  <h2 class="section-title"><a href="/group/desktop">Ubuntu Desktop</a></h2>
...
?><?php if (have_posts()) : ?>
<section class="box eight-col">
<h2 class="section-title"><a href="/group/phone-and-tablet">Phone and Tablet</a></h2>
    ...
    <ul class="no-bullets">
        ...
        if ($terms) {
            foreach($terms as $term) {
                if(($term->slug) != "canonical-announcements") echo '<li class="' . $style_classes[$style_index%2] . '">' . '<a href="group/' . $term->slug . '" ' . '>' . $term->name.'</a></li> ';
                $style_index++;
            }
        }
        ?>
        <li><a href="/group/canonical-announcements">Canonical announcements</a></li>
    </ul>
	</div>
</aside>
